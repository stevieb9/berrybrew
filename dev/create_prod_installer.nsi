...
Section Uninstall
  ...
  Delete "$INSTDIR\src\messaging.cs"
  Delete "$INSTDIR\src\perloperations.cs"
  Delete "$INSTDIR\src\perlinstance.cs"
  Delete "$INSTDIR\src\pathoperations.cs"
